...
import mypage.action.AdminIOListFormAction;
import mypage.action.AdminIOProAction;
import mypage.action.AdminIcecreamInserProAction;
...
public class MyPageFrontController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		} else if (command.equals("/adminIcecreamInserForm.bg")) {// 아이스크림 등록 폼
			forward = new ActionForward();
			forward.setPath("mypage/adminIcecreamInsertForm.jsp");
		} else if (command.equals("/adminIcecreamInsertPro.bg")) {// 아이스크림 등록 요청
			action = new AdminIcecreamInserProAction();
			try {
				forward = action.execute(request, response);
			} catch (Exception e) {
				e.printStackTrace();
		...
		} else if (command.equals("/adminIOListForm.bg")) {// 입고 내역 폼
			action = new AdminIOListFormAction();
			try {
				forward = action.execute(request, response);
			} catch (Exception e) {
				e.printStackTrace();
		...
		} else if (command.equals("/adminProductDeletePro.bg")) {// 물건 등록 수정 요청
		...
		} else if (command.equals("/adminProductListDeleteSuccess.bg")) {// 내 정보 탈퇴 성공 폼
			forward = new ActionForward();
